...
import { Brain, Send, SkipForward, Loader2, AlertCircle, ChevronRight, Target, Lightbulb } from 'lucide-react';
  ...
  const loadQuestion = async (id: number) => {
    ...
    try {
      ...
      if (resp.question) {
        ...
        setAnswer(''); setShowEvaluation(false); setLastEvaluation(null);
  ...
  const handleSubmitAnswer = async () => {
    ...
    try {
      const response = await apiRequest('assessment', 'POST', {
        assessment_id: assessmentId, question: currentQuestion, answer: answer.trim()
      }, { path: 'answer' });
      const resp = response as Record<string, unknown>;
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                {!showEvaluation ? (
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      <Button onClick={handleSubmitAnswer} disabled={!answer.trim() || loading} className="flex-1" size="lg">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• Отвечайте развёрнуто — AI анализирует глубину</li>
                <li>• Приводите примеры из практики</li>
                <li>• Если не знаете — честно скажите</li>
              </ul>
            </div>
          </div>
          <div className="space-y-4">
